                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <div className="text-justify py-8">
                                <p className="text-gray-700 dark:text-gray-300">
                                    ...
                                    <strong> ACIM – Associação Comercial e Empresarial de Maringá</strong> em parceria com o <strong>Hub de Inovação Fronteira - UEM</strong>. Com base em vivências reais do mercado e conhecimento prático acumulado ao longo de décadas, o conteúdo oferece uma análise estratégica e confiável para impulsionar sua empresa.
                                </p>
